...
public class MyArrayList<E> extends AbstractList<E> implements List<E>, RandomAccess, Cloneable, java.io.Serializable {
	...
	public MyArrayList(int initialCapacity) {
		...
		this.size = initialCapacity; //TODO fengqing
	}
	...
	/**
	 * Trims the capacity of this <tt>MyArrayList</tt> instance to be the list's
	 * current size. An application can use this operation to minimize the
	 * storage of an <tt>MyArrayList</tt> instance.
	 */
	...
	/**
	 * Save the state of the <tt>MyArrayList</tt> instance to a stream (that is,
	 * serialize it).
	 * 
